 ...
 * Диапазоны загружаются из файла один раз и кешируются в статической
 * переменной, чтобы избежать повторного чтения файла при последующих
 * вызовах функции.
 *
...
function isTelegramIP(string $ip): bool {
    // Статическая переменная хранит массив диапазонов после первого вызова.
    static $ranges = null;
    ...
    if ($ranges === null) {
        ...
        $ranges = require_once __DIR__ . '/config/telegram_ips.php';
    }
